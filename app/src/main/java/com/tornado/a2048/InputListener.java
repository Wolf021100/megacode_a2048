        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!hasMoved) {
                    if (iconPressed(mView.sXNewGame, mView.sYIcons)) {
                    ...
                    else if (iconPressed(mView.sXMusic, mView.sYIcons)) {
                        if(mView.music == true) {
                        //    mView.game.revertUndoState();
                            mView.music = false;
                            Intent intent = new Intent(this.mView.getContext(), BackgroundSoundService.class);
                        ...
                        else
                        {
                           ...
                           // mView.game.revertUndoState();
                            Intent intent = new Intent(this.mView.getContext(), BackgroundSoundService.class);
                            this.mView.getContext().startService(intent);
                        }
