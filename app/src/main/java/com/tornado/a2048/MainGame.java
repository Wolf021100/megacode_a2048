...
public class MainGame {
    ...
    public static  int startingMaxValue = 2048;
    ...
    private static final String HIGH_SCORE1 = "high score1";
    private static final String HIGH_SCORE2 = "high score2";
    private static int endingMaxValue;
    public static  int numSquaresX = 3;
    public static  int numSquaresY = 3;
    ...
    public MainGame(Context context, MainView view,int type) {
        this.type = type;
        if(type == 0)
        {
            startingMaxValue = 2048;
            numSquaresX = 3;
            numSquaresY = 3;
        }
        else if(type ==1)
        {
            startingMaxValue = 4096;
            numSquaresX = 4;
            numSquaresY = 4;
        }
        else if (type ==2)
    ...
    private void recordHighScore() {
        ...
        editor.putLong(HIGH_SCORE, highScore);
            ...
            editor.putLong(HIGH_SCORE1, highScore);
        else if(type ==2)
            editor.putLong(HIGH_SCORE2, highScore);
        editor.commit();
    }
    ...
    private long getHighScore() {
        ...
        if(type ==0) {
            ...
            return settings.getLong(HIGH_SCORE1, -1);
        }
        else if(type ==2) {
            return settings.getLong(HIGH_SCORE2, -1);
        }
        return settings.getLong(HIGH_SCORE, -1);
    }
