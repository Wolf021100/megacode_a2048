...
public class MainView extends View {
    ...
    public MainView(Context context,int type,int newgame, boolean sound) {
        super(context);
        music =sound;
        this.type = type;
        //Loading resources
        game = new MainGame(context, this,type);
        try {
            //Getting assets
    ...
    private void drawMusicButton(Canvas canvas) {
        ...
        drawDrawable(canvas,
                getDrawable(R.drawable.soundonwhite),
    ...
    private void drawHeader(Canvas canvas) {
        ...
        canvas.drawText(s, startingX, headerStartY, paint);
    }
    ...
    private void getLayout(int width, int height) {
      ...
      /*  titleTextSize = textSize ;
        ...
        sXMusic = sXUndo - iconSize * 3 / 2 - iconPaddingSize;
        resyncTime();
    }
